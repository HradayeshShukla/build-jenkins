...
RUN yum repolist --verbose || sleep 80
RUN cat /etc/redhat-release && ca /etc/yum.repos.d/redhat.repo && sleep 80 && yum repolist && yum -y install vulkan redhat-lsb libXScrnSaver \
